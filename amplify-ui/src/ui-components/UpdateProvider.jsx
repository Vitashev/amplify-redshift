...
export default function UpdateProvider(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = initialData
      ...
      : initialValues;
    setCms_certification_number_ccn(cleanValues.cms_certification_number_ccn);
    setProvider_name(cleanValues.provider_name);
    setProvider_address(cleanValues.provider_address);
  ...
  React.useEffect(() => {
    if (initialData) {
      setCms_certification_number_ccn(initialData.cms_certification_number_ccn);
      setProvider_name(initialData.provider_name);
      setProvider_address(initialData.provider_address);
      setCitytown(initialData.citytown);
      setState(initialData.state);
      setZip_code(initialData.zip_code);
      setTelephone_number(initialData.telephone_number);
    }
  }, []);
  const validations = {
    cms_certification_number_ccn: [],
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "UpdateProvider")}
      {...rest}
    >
      <TextField
